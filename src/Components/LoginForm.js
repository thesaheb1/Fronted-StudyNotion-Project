    ...
    className="flex flex-col w-full gap-y-4 mt-6">
      <label className="w-full">
        ...
        <input
          ...
          className="bg-[rgba(255,255,255,0.2)] rounded-[0.5rem] text-gray-200 w-full p-[12px]"
        />
      </label>
      ...
      <button className="bg-yellow-500 rounded-[8px] font-medium text-black p-[8px] mt-4">Sign In</button>
    </form>
  );
}
